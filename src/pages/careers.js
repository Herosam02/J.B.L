...
const roles = [
  ['Field Engineering', 'Site Engineer', 'Join our field teams delivering telecom and electrical installations across active sites. Engineering qualification and field experience required.'],
  ['Electrical', 'Electrical Technician', 'Install and maintain power distribution, backup systems and earthing across project sites. Electrical qualification and safety awareness required.'],
  ['Telecoms', 'Telecoms Installer', 'Install, integrate and maintain telecom equipment and infrastructure. Experience with BTS and transmission systems preferred.'],
  ['Operations', 'Project Coordinator', 'Coordinate field teams, logistics and project delivery. Strong organisation and communication skills required.'],
]

const html = `
  <section class="page-hero">
    <div class="page-hero-image" style="background-image:url('${IMAGES.team}')"></div>
  ...
  <section class="page-section">
    ...
    <div class="grid-2" style="align-items:center">
      ...
      <div class="image-block reveal" style="background-image:url('${IMAGES.construction}')"></div>
    </div>
  </section>
  ...
  <section class="page-section alt">
    ...
    <div class="grid-2">
      ${roles.map(([dept, title, desc]) => `<div class="career-card reveal"><p class="dept">${dept}</p><h3>${title}</h3><p>${desc}</p><a class="apply" href="contact.html">Apply for this role →</a></div>`).join('')}
    </div>
  </section>
...
document.querySelector('#app').innerHTML = renderShell('Careers', html)
initShell()

...
const values = [
  ['01', 'Integrity & honesty', 'We conduct all operations with transparency, accountability and trust.'],
  ['02', 'Safety first', 'We adhere to industry standards and protect people, assets and the environment.'],
  ['03', 'Customer-centred', 'We listen carefully, understand needs and deliver solutions that add real value.'],
  ['04', 'Commitment to excellence', 'Every project is executed with precision, professionalism and care.'],
]

const html = `
  <section class="page-hero">
    <div class="page-hero-image" style="background-image:url('${IMAGES.night}')"></div>
...
document.querySelector('#app').innerHTML = renderShell('Values', html)
initShell()

import{I as e,r,i}from"./layout-BnW1ESXn.js";const n=[["01","Understand","We listen, survey the site and understand the outcome that matters."],["02","Plan","We translate requirements into a clear, safe and efficient delivery plan."],["03","Deliver","Our field teams install, integrate and commission with discipline."],["04","Support","We stay close after handover with practical ongoing maintenance."]],o=`
  ...
  <section class="page-section">
    ...
    <div class="process-steps">
      ${n.map(([s,a,t])=>`<div class="process-step reveal"><span>${s}</span><h3>${a}</h3><p>${t}</p></div>`).join("")}
    </div>
  </section>
  ...
  <section class="page-section alt">
    ...
    <div class="grid-2" style="align-items:center">
      <div class="image-block reveal" style="background-image:url('${e.meeting}')"></div>
      <div class="reveal">
...
`;document.querySelector("#app").innerHTML=r("Process",o);i();
